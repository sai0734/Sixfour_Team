...
public class WeddingPlanController {
    ...
    @PostMapping("/")
    public Map<String, Long> register(@RequestBody WeddingPlanDTO weddingPlanDTO) {
    ...
    public Map<String, String> modify(
        ...
        service.modify(weddingPlanDTO);

        return Map.of("RESULT", "SUCCESS");
    }

    @DeleteMapping("/{weddingPlanId}")
    public Map<String, String> remove(@PathVariable(name = "weddingPlanId") Long weddingPlanId) {

        log.info("Remove: " + weddingPlanId);

        service.remove(weddingPlanId);
