...
public class AiDressTryOnServiceImpl implements AiDressTryOnService {
  ...
  public AiDressTryOnResponseDTO tryOn(String memberEmail, AiDressTryOnRequestDTO requestDTO) {
    ...
    String resultUrl = callVirtualTryOnApi(photoFileName, dressItem.getImageUrl());
  ...
  private String callVirtualTryOnApi(String personFileName, String dressImageUrl) {
    // TODO: Replicate / FASHN 등 AI 가상피팅 API 연동
    throw new UnsupportedOperationException("AI 합성 API 연동이 필요합니다.");
  }
}
