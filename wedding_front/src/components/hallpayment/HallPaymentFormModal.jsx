...
export const TYPE_OPTIONS = ["계약금", "잔금"];
export const STATUS_OPTIONS = ["대기", "완료", "취소"];
    ...
    <div className="fixed inset-0 bg-black/30 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-2xl w-full max-w-md p-6">
        ...
        <div className="flex flex-col gap-4 mt-2">
          ...
          <label className="flex flex-col gap-2">
            <span className="text-xs font-medium text-ink-soft">구분</span>
            <select
          ...
          <label className="flex flex-col gap-2">
            <span className="text-xs font-medium text-ink-soft">금액 (원)</span>
            <input
              className="h-11 px-4 rounded-lg border border-line-soft text-sm focus:outline-none focus:border-brand"
              name="amount"
              type="number"
          ...
          <label className="flex flex-col gap-2">
            <span className="text-xs font-medium text-ink-soft">납부 기한</span>
            <input
              className="h-11 px-4 rounded-lg border border-line-soft text-sm focus:outline-none focus:border-brand"
              name="dueDate"
              type="date"
...
export default HallPaymentFormModal;
