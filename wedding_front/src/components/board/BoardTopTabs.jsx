...
const BoardTopTabs = ({ active }) => {
  ...
  return (
    <div className="sticky top-[68px] z-20 -mx-5 bg-cream/95 px-5 py-3 backdrop-blur md:mx-0 md:bg-transparent md:px-0 md:py-0 md:backdrop-blur-0 lg:static">
          ...
          return (
            <Link
              ...
              className={`shrink-0 whitespace-nowrap rounded-full px-4 py-2 text-sm font-medium transition-colors md:rounded-none md:px-0 md:pb-3 md:pt-0 md:border-b ${
                isActive
                  ? "bg-brand-deep text-white md:bg-transparent md:text-brand md:border-brand"
                  : "bg-white text-ink hover:bg-blush-100 md:bg-transparent md:text-ink-soft md:border-transparent md:hover:bg-transparent md:hover:text-ink"
              }`}
            >
              {tab.label}
            </Link>
